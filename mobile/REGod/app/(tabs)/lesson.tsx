...
export default function LessonScreen() {
  const { chapterTitle } = useLocalSearchParams<{ chapterTitle: string }>();

  return (
    <SafeAreaView style={styles.container}>
      <Stack.Screen options={{ title: chapterTitle, headerBackTitle: 'Course' }} />
      <ScrollView>
        {/* Header Image */}
        <Image 
          source={require('@/assets/images/favicon.png')} // Replace with actual chapter image
